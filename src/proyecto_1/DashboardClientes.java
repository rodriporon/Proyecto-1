...
public class DashboardClientes extends JFrame implements ActionListener{
    ...
    public int contadorclientes, contadorproductos, contadorventas;

    public Productos[] productos;
    public DashboardClientes(Usuario[] usuarios, int contadorusuarios, Clientes[] clientes, int contadorclientes, Productos[] productos, int contadorproductos, Ventas[] ventas, int contadorventas) {
